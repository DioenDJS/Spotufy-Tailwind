...
export default function Home() {
  return (
    /*h-screen: fara com que a div ocupe toda a altura da pagina 
      flex: permitira que a div seja redimencionada 
      flex-1: dimenciona o restante do espaço que sobrar 
    */
      ...
      <div className="flex flex-1">
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className='mt-6 pt-6 border-t border-zinc-800 flex flex-col gap-3'>
            <a href="" className="text-sm text-zinc-400">Hot Hits Brasil</a>
            <a href="" className="text-sm text-zinc-400">Aniver Funk</a>
            <a href="" className="text-sm text-zinc-400">My Playlist #13</a>
            <a href="" className="text-sm text-zinc-400">Top Brasil</a>
          </nav>
        </aside>
